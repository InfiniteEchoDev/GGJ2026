...
namespace com.ggj2026teamname.gamename
{
    ...
    public sealed class MaskLinePresenter : DialoguePresenterBase
    {
        ...
        [SerializeField] private UnityEvent _onTypewriterStart;
        [SerializeField] private UnityEvent _onTypewriterEnd;
